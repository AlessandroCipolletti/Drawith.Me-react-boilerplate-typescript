...
module.exports = {
  ...
  actions: data => {
    ...
    const actions = [
      {
        type: 'add',
        path: '../../app/common/components/{{properCase name}}/index.js',
    ...
    if (data.wantMessages) {
      actions.push({
        type: 'add',
        path: '../../app/common/components/{{properCase name}}/messages.js',
    ...
    if (data.wantLoadable) {
      actions.push({
        type: 'add',
        path: '../../app/common/components/{{properCase name}}/Loadable.js',
